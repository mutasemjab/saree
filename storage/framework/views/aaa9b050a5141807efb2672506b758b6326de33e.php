                ...
                <div class="card">
                    ...
                    <div class="card-body border-bottom">
                        <form method="GET" action="<?php echo e(route('drivers.index')); ?>" class="row g-3">
                            ...
                            <!-- City Filter -->
                            <div class="col-md-2">
                                <label for="city_id" class="form-label"><?php echo e(__('messages.City')); ?></label>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="sortDropdown">
                                    <li>
                                        <a class="dropdown-item"
                                            href="<?php echo e(request()->fullUrlWithQuery(['sort_by' => 'name', 'sort_order' => 'asc'])); ?>">
                                            <?php echo e(__('messages.name')); ?> (A-Z)
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item"
                                            href="<?php echo e(request()->fullUrlWithQuery(['sort_by' => 'name', 'sort_order' => 'desc'])); ?>">
                                            <?php echo e(__('messages.name')); ?> (Z-A)
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item"
                                            href="<?php echo e(request()->fullUrlWithQuery(['sort_by' => 'created_at', 'sort_order' => 'desc'])); ?>">
                                    ...
                                    <li>
                                        <a class="dropdown-item"
                                            href="<?php echo e(request()->fullUrlWithQuery(['sort_by' => 'created_at', 'sort_order' => 'asc'])); ?>">
                                        ...
                                        <th>
                                            <a href="<?php echo e(request()->fullUrlWithQuery(['sort_by' => 'id', 'sort_order' => request('sort_order') === 'asc' ? 'desc' : 'asc'])); ?>"
                                                ...
                                                <?php if(request('sort_by') === 'id'): ?>
                                                    <i
                                                        class="fas fa-sort-<?php echo e(request('sort_order') === 'asc' ? 'up' : 'down'); ?>"></i>
                                                <?php endif; ?>
                                            </a>
                                        </th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="<?php echo e(asset('assets/admin/uploads') . '/' . $driver->photo); ?>"
                                                    alt="<?php echo e($driver->name); ?>" class="rounded-circle" width="50"
                                                    height="50">
                                            </td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-<?php echo e($driver->activate == 1 ? 'success' : 'danger'); ?>">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <form action="<?php echo e(route('drivers.toggle-activation', $driver)); ?>"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <i
                                                                class="fas fa-<?php echo e($driver->activate == 1 ? 'ban' : 'check'); ?>"></i>
                                                        </button>
                                                    </form>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
                                            <td colspan="7" class="text-center">
                                                <?php if(request()->anyFilled(['search', 'status', 'city_id', 'date_from', 'date_to'])): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sline\resources\views/admin/drivers/index.blade.php ENDPATH**/ ?>