                                ...
                                <form method="GET" action="<?php echo e(route('orders.index')); ?>" class="row g-3">
                                    ...
                                    <div class="col-md-2">
                                        <select name="status" class="form-control">
                                            ...
                                            <option value="4" <?php echo e(request('status') == '4' ? 'selected' : ''); ?>>
                                                <?php echo e(__('messages.delivered')); ?></option>
                                            <option value="5" <?php echo e(request('status') == '5' ? 'selected' : ''); ?>>
                                                <?php echo e(__('messages.cancelled_by_user')); ?></option>
                                            <option value="6" <?php echo e(request('status') == '6' ? 'selected' : ''); ?>>
                                                <?php echo e(__('messages.cancelled_by_driver')); ?></option>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <select name="payment_type" class="form-control">
                                            ...
                                            <option value="1" <?php echo e(request('payment_type') == '1' ? 'selected' : ''); ?>>
                                                <?php echo e(__('messages.paid')); ?></option>
                                            <option value="2" <?php echo e(request('payment_type') == '2' ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-md-2">
                                        <select name="payment_method" class="form-control">
                                            ...
                                            <option value="1"
                                                <?php echo e(request('payment_method') == '1' ? 'selected' : ''); ?>>
                                                <?php echo e(__('messages.cash')); ?></option>
                                            <option value="2"
                                                <?php echo e(request('payment_method') == '2' ? 'selected' : ''); ?>>
                                        ...
                                        <tr>
                                                ...
                                                <?php if($order->user): ?>
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            ...
                                                            <small>
                                                                <a href="tel:<?php echo e($order->user->phone); ?>"
                                                ...
                                                <?php if($order->driver): ?>
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            ...
                                                            <small>
                                                                <a href="tel:<?php echo e($order->driver->phone); ?>"
                                                                    class="text-decoration-none text-success">
                                                                    <i class="fas fa-phone-alt"></i>
                                                                    <?php echo e($order->driver->phone); ?>
                                            ...
                                            <td>
                                                <?php if($order->final_price): ?>
                                                    <span class="fw-bold"><?php echo e(number_format($order->final_price, 2)); ?>

                                                        <?php echo e(__('messages.currency')); ?></span>
                                                    <?php if($order->discount > 0): ?>
                                                        <br><small class="text-muted"><?php echo e(__('messages.discount')); ?>:
                                                            <?php echo e(number_format($order->discount, 2)); ?></small>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-<?php echo e($order->payment_type == 1 ? 'success' : 'warning'); ?>">
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-<?php echo e($order->payment_method == 1 ? 'info' : 'primary'); ?>">
                                            ...
                                            <td>
                                                ...
                                                <form id="cancel-form-<?php echo e($order->id); ?>"
                                                    action="<?php echo e(route('orders.cancel', $order)); ?>" method="POST"
                                                    style="display: none;">
                                                    <?php echo csrf_field(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"
                        data-bs-dismiss="modal"><?php echo e(__('messages.no_cancel')); ?></button>
                    <button type="button" class="btn btn-danger"
                        id="confirmCancelBtn"><?php echo e(__('messages.yes_cancel')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sline\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>