...
<?php $__env->startSection('title', __('messages.live_map')); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-header mb-4">
                    <h1><?php echo e(__('messages.live_map')); ?></h1>
                    <p class="text-muted"><?php echo e(__('messages.map_description')); ?></p>
                </div>

                <!-- Statistics Cards -->
                <div class="driver-stats">
                    <div class="stat-card online">
                        <h3><?php echo e(__('messages.online_drivers')); ?></h3>
                        <div class="value" id="onlineCount">0</div>
                    </div>
                    <div class="stat-card offline">
                        <h3><?php echo e(__('messages.offline_drivers')); ?></h3>
                        <div class="value" id="offlineCount">0</div>
                    </div>
                    <div class="stat-card">
                        <h3><?php echo e(__('messages.total_drivers')); ?></h3>
                        <div class="value" id="totalCount">0</div>
                    </div>
                    <div class="stat-card" style="background-color: #fff3cd;">
                        <h3><?php echo e(__('messages.drivers_without_location')); ?></h3>
                ...
                <div class="last-update">
                    ...
                    <?php echo e(__('messages.last_update')); ?>: <strong id="lastUpdateTime">--:--</strong>
                ...
                <div class="map-container mt-3">
                    <div class="map-controls">
                        <button class="btn btn-primary btn-sm" id="refreshBtn">
                            <i class="fas fa-sync-alt"></i> <?php echo e(__('messages.refresh_now')); ?>

                        </button>
                        <button class="btn btn-secondary btn-sm" id="centerMapBtn">
                            <i class="fas fa-crosshairs"></i> <?php echo e(__('messages.center_map')); ?>
                ...
                <div class="alert alert-warning mt-3" id="noLocationAlert" style="display: none;">
                    <h5 class="alert-heading">
                        ...
                        <?php echo e(__('messages.drivers_without_firebase_location')); ?>

                    </h5>
                    <p class="mb-2"><?php echo e(__('messages.drivers_without_location_description')); ?></p>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function createPopupContent(driver) {
            ...
            const statusText = driver.status === 'online' ? '<?php echo e(__('messages.online')); ?>' :
                '<?php echo e(__('messages.offline')); ?>';

            return `
            <div class="driver-popup">
                <div class="driver-name">${driver.name}</div>
                <div class="driver-info">
                    <i class="fas fa-phone"></i> ${driver.phone || '<?php echo e(__('messages.no_phone')); ?>'}
                </div>
                <div class="driver-info">
                    <i class="fas fa-wallet"></i> <?php echo e(__('messages.balance')); ?>: ${driver.balance} <?php echo e(__('messages.currency')); ?>
            ...
            <div class="no-location-table">
                <table>
                    <thead>
                        <tr>
                            <th>#</th>
                            <th><?php echo e(__('messages.driver_id')); ?></th>
        ...
        `;
                ...
                <tr>
                    ...
                    <td>${driver.balance} <?php echo e(__('messages.currency')); ?></td>
        ...
        function fetchDriverLocations() {
            ...
            fetch('<?php echo e(route('map.locations')); ?>')
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        const now = new Date();
                        const timeString = now.toLocaleTimeString('<?php echo e(app()->getLocale()); ?>');
                        ...
                        toastr.success('<?php echo e(__('messages.map_updated')); ?>');
                    } else {
                        console.error('Error fetching driver locations:', data.message);
                        toastr.error(data.message || '<?php echo e(__('messages.error_loading_locations')); ?>');
                    }
                })
                .catch(error => {
                    console.error('Error:', error);
                    toastr.error('<?php echo e(__('messages.error_loading_locations')); ?>');
                })
                .finally(() => {
        ...
        function centerMap() {
            if (Object.keys(markers).length > 0) {
                const group = new L.featureGroup(Object.values(markers));
                map.fitBounds(group.getBounds().pad(0.1));
                toastr.info('<?php echo e(__('messages.map_centered')); ?>');
            } else {
                toastr.info('<?php echo e(__('messages.no_drivers_to_center')); ?>');
            }
        }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sline\resources\views/admin/drivers/map.blade.php ENDPATH**/ ?>