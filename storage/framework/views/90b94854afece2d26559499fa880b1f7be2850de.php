        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><?php echo e(__('messages.edit_driver')); ?></h3>
...
unset($__errorArgs, $__bag); ?>" required>
                                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($city->id); ?>" <?php echo e(old('city_id', $driver->city_id) == $city->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('identity_number', $driver->identity_number)); ?>" 
                                           required>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="1" <?php echo e(old('car_type', $driver->car_type) == '1' ? 'selected' : ''); ?>>
                                            <?php echo e(__('messages.car')); ?>

                                        </option>
                                        <option value="2" <?php echo e(old('car_type', $driver->car_type) == '2' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="password" 
                                           name="password">
                                    <small class="form-text text-muted"><?php echo e(__('messages.leave_blank_to_keep_current')); ?></small>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/saree/resources/views/admin/drivers/edit.blade.php ENDPATH**/ ?>