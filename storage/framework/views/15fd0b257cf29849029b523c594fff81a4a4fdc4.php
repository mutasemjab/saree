            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><?php echo e(__('messages.add_user')); ?></h3>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label for="phone" class="form-label"><?php echo e(__('messages.phone')); ?> <span
                                                class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="activate" class="form-label"><?php echo e(__('messages.status')); ?> <span
                                                class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>" id="activate"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/saree/resources/views/admin/users/create.blade.php ENDPATH**/ ?>