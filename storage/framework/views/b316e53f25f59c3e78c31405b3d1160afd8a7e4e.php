...
<?php $__env->startSection('title', __('messages.Orders Todays')); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title"><?php echo e(__('messages.Orders Todays')); ?></h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <form method="GET" action="<?php echo e(route('orders.today')); ?>" class="row g-3">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="<?php echo e(route('orders.today')); ?>" class="btn btn-outline-secondary">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/saree/resources/views/admin/orders/today.blade.php ENDPATH**/ ?>