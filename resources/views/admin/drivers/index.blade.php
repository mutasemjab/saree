            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('drivers.export', request()->query()) }}" class="btn btn-success me-2">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="sortDropdown">
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ request()->fullUrlWithQuery(['sort_by' => 'name', 'sort_order' => 'asc']) }}">
                                            {{ __('messages.name') }} (A-Z)
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ request()->fullUrlWithQuery(['sort_by' => 'name', 'sort_order' => 'desc']) }}">
                                            {{ __('messages.name') }} (Z-A)
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ request()->fullUrlWithQuery(['sort_by' => 'created_at', 'sort_order' => 'desc']) }}">
                                            {{ __('messages.newest_first') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ request()->fullUrlWithQuery(['sort_by' => 'created_at', 'sort_order' => 'asc']) }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('assets/admin/uploads') . '/' . $driver->photo }}"
                                                    alt="{{ $driver->name }}" class="rounded-circle" width="50"
                                                    height="50">
                                            </td>
                                            <td>{{ $driver->name }}</td>
                                            <td>{{ $driver->phone }}</td>
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <form action="{{ route('drivers.toggle-activation', $driver) }}"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <i
                                                                class="fas fa-{{ $driver->activate == 1 ? 'ban' : 'check' }}"></i>
                                                        </button>
                                                    </form>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center">
                                                @if (request()->anyFilled(['search', 'status', 'city_id', 'date_from', 'date_to']))
